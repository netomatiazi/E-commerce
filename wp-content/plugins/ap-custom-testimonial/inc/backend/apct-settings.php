...
<div class="afct-option-setting-wrapper">
    ...
    <div class="apct-general-setting-section color-setting-section"> 
        ...
        <div class="color-setting-op">
            <label for="testim_author_font_color"><h4><?php _e('Author Text Color', 'ap-custom-testimonial'); ?></h4></label>
            <input type="text" name="testim_author_font_color" id="testim_author_font_color" class="apct-color-field"value="<?php if (isset($options['testim_author_font_color'])) {
                       echo $options['testim_author_font_color'];
                   } ?>"/><br />
        </div>
        <div class="color-setting-op">
