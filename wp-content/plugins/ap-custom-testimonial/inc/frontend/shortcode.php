    ...
    <style> 
        ...
        #<?php echo $random_id; ?> a.apct-links 
        {
            ...
            if (!empty($options['testim_author_title_color'])) {
                echo esc_attr($options['testim_author_title_color']) . '!important';
            } else {
                echo 'inherit';
            }
            ?>;
        ...
        #<?php echo $random_id; ?> #template-1 .apct-testimonial-title-name, 
        #<?php echo $random_id; ?> #template-4 .apct-testimonial-title-name{
            font-family: <?php
            if ((!empty($options['testim_font_family'])) && $options['testim_font_family'] != 'default') {
                echo esc_attr($options['testim_font_family']);
            } else {
            ...
            ?>;
            color: <?php
            if (!empty($options['testim_author_font_color'])) {
                echo esc_attr($options['testim_author_font_color']);
            } else {
                echo '#25a4c8';
            }
            ?>;    
        ...
        #<?php echo $random_id; ?> #template-3 .apct-testimonial-title-name,
        #<?php echo $random_id; ?> #template-5 .apct-testimonial-title-name{
            color: <?php
            if (!empty($options['testim_author_font_color'])) {
                echo esc_attr($options['testim_author_font_color']);
            } else {
